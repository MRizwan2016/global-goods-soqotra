...
const AdditionalDestinations = () => {
  ...
  return (
    <div className="mb-8 animate-fade-in bg-gradient-to-br from-purple-50 to-pink-50 rounded-3xl p-8 border-2 border-gray-800 shadow-lg hover:shadow-2xl transition-all duration-500 hover:scale-105">
