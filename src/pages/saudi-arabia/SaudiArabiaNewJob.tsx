...
const SaudiArabiaNewJob = () => {
    ...
    setItems((prev) =>
      prev.map((item) => {
        ...
        if (["lengthCm", "widthCm", "heightCm"].includes(field)) {
          updated.cbm =
            (updated.lengthCm * updated.widthCm * updated.heightCm) / 1000000;
        }
        return updated;
      })
    );
  ...
  const sectorPricing =
    doorToDoorPricing[jobData.sector as keyof typeof doorToDoorPricing];
      ...
      <div className="space-y-6 max-w-5xl mx-auto">
        ...
        <Card>
          ...
          <CardContent className="pt-4 grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div>
              <Label>Date</Label>
              <Input type="date" value={jobData.date} onChange={(e) => updateField("date", e.target.value)} />
            </div>
            <div>
              <Label>Time</Label>
              <Input type="time" value={jobData.time} onChange={(e) => updateField("time", e.target.value)} />
            </div>
            <div>
        ...
        <Card>
          ...
          <CardContent className="pt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <Input placeholder="+966 5XXXXXXXX" value={jobData.mobileNumber} onChange={(e) => updateField("mobileNumber", e.target.value)} />
            </div>
            <div>
              <Label>City *</Label>
                  ...
                  <TableRow key={item.id}>
                    <TableCell>
                      <Select value={item.description} onValueChange={(v) => updateItem(item.id, "description", v)}>
                        ...
                        <SelectContent>
                          {saudiArabiaPackageTypes.map((p, i) => (
                    ...
                    <TableCell>
                      <Button variant="ghost" size="sm" onClick={() => removeItem(item.id)} className="text-destructive p-1">
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              ...
              <div className="flex justify-between text-lg">
                ...
                <span className="font-bold text-[#006c35]">SAR {estimatedCost.toFixed(2)}</span>
              </div>
