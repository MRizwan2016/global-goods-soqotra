...
const ReceiptHandler: React.FC<ReceiptHandlerProps> = ({ formState, customerName }) => {
  ...
  return (
    <>
      ...
      />
      {/* Expose generateReceipt function through React ref */}
      {React.createElement('div', {
        ref: (el) => {
          if (el) {
            (el as any).generateReceipt = generateReceipt;
          }
        },
        style: { display: 'none' }
      })}
