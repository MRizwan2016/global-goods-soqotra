...
import { ArrowLeft, Search, AlertCircle, Calendar as CalendarIcon, CreditCard, DollarSign, CheckCircle2 } from "lucide-react";
        ...
        <div className="container mx-auto p-6">
          ...
          >
            <Button 
              ...
              className="mr-4 border-blue-200 text-blue-700 hover:bg-blue-50 hover:text-blue-800"
            >
          ...
          <motion.div
            ...
            animate="show"
          >
            <Card className="mb-8 shadow-lg border-t-4 border-t-blue-500 overflow-hidden">
              ...
              <CardContent className="pt-6">
                  ...
                  <div className="w-full max-w-md relative">
                    ...
                    <div className="flex">
                      <Input
                        ...
                        className="rounded-r-none border-r-0 focus-visible:ring-1 focus-visible:ring-blue-400"
                      />
                      <Button 
                    ...
                    <AnimatePresence>
                      {showInvoiceSelector && (
                        <motion.div 
                          ...
                          animate={{ opacity: 1, y: 0 }}
                          exit={{ opacity: 0, y: 5 }}
                          className="mt-1 border rounded-md shadow-lg max-h-60 overflow-y-auto absolute z-10 bg-white w-full border-blue-200"
                        >
                              ...
                              {matchingInvoices.map((invoice) => (
                                ...
                                >
                                  <div className="flex justify-between">
                                    <span className="font-medium text-blue-800">{invoice.invoiceNumber}</span>
                                    <span className="text-sm text-gray-500">{invoice.consignee1}</span>
                                  </div>
                                  <div className="flex justify-between text-xs text-gray-500 mt-1">
                                    <span className="text-blue-600 font-medium">Amount: ${invoice.net}</span>
                ...
                {selectedInvoice && (
                  <motion.div 
                    ...
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ duration: 0.3 }}
                    className="border p-4 rounded-md bg-gradient-to-r from-blue-50 to-sky-50 mb-6 shadow-inner"
                  >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      ...
                      <div>
                        ...
                        <p className="font-semibold text-gray-900">${selectedInvoice.net}</p>
                      </div>
                      <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
                    ...
                    <motion.div variants={item} className="flex flex-col md:col-span-2">
                      ...
                      <Textarea
                        ...
                        onChange={handleInputChange}
                        className="min-h-[80px] border-gray-200 focus-visible:ring-blue-400"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4 bg-gray-50 p-4 rounded-lg">
                      ...
                      <motion.div variants={item} className="flex flex-col">
                        ...
                        <Input
                          ...
                          onChange={handleInputChange}
                          type="number"
                          className="bg-blue-50 border-blue-100 font-bold text-blue-800"
                          readOnly
                        />
                      </motion.div>
                      ...
                      <motion.div variants={item} className="flex flex-col">
                        ...
                        <Input
                          ...
                          onChange={handleInputChange}
                          type="number"
                          className="bg-amber-50 border-amber-100 font-bold text-amber-800"
                          readOnly
                        />
                      </motion.div>
                    </div>
                    
                    <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-x-6 gap-y-4 p-4 bg-gradient-to-r from-green-50 to-blue-50 rounded-lg border border-blue-100">
                      <motion.div 
                        variants={item} 
                      ...
                      >
                        ...
                        <Input
                          ...
                          onChange={handleInputChange}
                          type="number"
                          className="border-green-200 focus-visible:ring-green-300 font-medium"
                        />
                      </motion.div>
