...
const BookingFormActivate = () => {
  ...
  const handleSave = () => {
    ...
    toast.success("Booking form activated successfully");
  ...
  return (
    <Layout title="Activate Booking Form">
      <div className="bg-white rounded-lg shadow-sm border border-gray-200">
        <div className="p-4 bg-green-50 border-b border-green-100">
          <h3 className="text-lg font-medium text-green-800">
            Activate Booking Form Stock
          </h3>
        </div>
...
export default BookingFormActivate;
