...
const BillOfLadingMode: React.FC<BillOfLadingModeProps> = ({
  ...
  return (
    <div className="border border-black p-6 house-bill-of-lading bg-white text-black">
      ...
      <table className="w-full border-collapse mb-3 text-sm bg-white">
        <thead>
          <tr>
            <th className="border p-1 bg-white text-black">MARKS & NUMBERS</th>
            <th className="border p-1 bg-white text-black">DESCRIPTION OF GOODS</th>
            <th className="border p-1 bg-white text-black">WEIGHT (KG)</th>
            <th className="border p-1 bg-white text-black">VOLUME (CBM)</th>
          </tr>
        </thead>
        <tbody>
          <tr>
            <td className="border p-1 bg-white">AS ADDRESSED</td>
            <td className="border p-1 whitespace-pre-line break-words bg-white">
              {formatPackageDetails()}
              <div className="mt-1">SAID TO CONTAIN USED PERSONAL EFFECTS</div>
            </td>
            <td className="border p-1 text-center bg-white">{totalWeight}</td>
            <td className="border p-1 text-center bg-white">{totalVolume}</td>
          </tr>
        </tbody>
      </table>
