        ...
        <Table>
            ...
            {cargoItems.length === 0 ? (
              ...
              cargoItems.map((item, index) => (
                <TableRow key={item.id} className={index % 2 === 0 ? "bg-white" : "bg-gray-50"}>
                  ...
                  <TableCell className="border-r border-gray-200 uppercase">{item.invoiceNumber}</TableCell>
                  ...
                  <TableCell className="border-r border-gray-200 uppercase">{item.packageName}</TableCell>
                  ...
                  <TableCell className="border-r border-gray-200 uppercase">{item.consignee}</TableCell>
                  <TableCell className="border-r border-gray-200 uppercase">{item.shipper}</TableCell>
                  <TableCell className="border-r border-gray-200 uppercase">{item.wh}</TableCell>
                  <TableCell className="border-r border-gray-200 uppercase">{item.d2d ? "YES" : "NO"}</TableCell>
                  <TableCell className="text-center">
                    <Button 
                      variant="default" 
                      size="sm" 
                      className="bg-blue-600 hover:bg-blue-700 hover:scale-105 transition-all whitespace-normal p-2 h-auto text-xs uppercase"
                    >
                      {item.packageName}
                    </Button>
                  </TableCell>
          ...
          <TableFooter>
            <TableRow className="bg-gray-100">
              <TableCell colSpan={5} className="text-right font-bold uppercase">TOTAL:</TableCell>
