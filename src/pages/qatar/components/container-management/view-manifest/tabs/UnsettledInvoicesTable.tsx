...
interface UnsettledInvoicesTableProps {
  unsettledInvoices: any[];
}

const UnsettledInvoicesTable: React.FC<UnsettledInvoicesTableProps> = ({ unsettledInvoices }) => {
  return (
...
export default UnsettledInvoicesTable;
