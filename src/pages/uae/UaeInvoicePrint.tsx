...
const UaeInvoicePrint = () => {
  ...
  useEffect(() => {
    if (id) {
      const storedInvoices = localStorage.getItem('uaeInvoices');
      if (storedInvoices) {
          ...
          <div className="border border-black">
            ...
            <div className="flex border-t border-black">
              ...
              <div className="w-1/2 p-2">
                ...
                <div>AL WASL DISTRICT</div>
                <div>JUMEIRAH</div>
                <div>DUBAI, UAE</div>
                <div>EMIRATES ID : {invoiceData.consignee?.idNumber || "784123456789012"}</div>
                <div className="mt-1 font-semibold">Mobile: {invoiceData.consignee?.mobile || "+971 50 123 4567"}</div>
              </div>
            </div>

            {/* Destination */}
            <div className="border-t border-black p-2 flex">
              <div className="font-bold">Destination Warehouse: Dubai</div>
                ...
                <table className="w-full">
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-black p-2 text-right">{(invoiceData.pricing?.gross || 0).toFixed(2)} AED</td>
                    </tr>
                    <tr>
                      <td className="border border-black p-2 font-bold">DISCOUNT:</td>
                      <td className="border border-black p-2 text-right">{(invoiceData.pricing?.discount || 0).toFixed(2)} AED</td>
                    </tr>
                    <tr>
                      <td className="border border-black p-2 font-bold">NET:</td>
                      <td className="border border-black p-2 text-right font-bold">{(invoiceData.pricing?.net || 0).toFixed(2)} AED</td>
                    </tr>
                    <tr>
...
export default UaeInvoicePrint;