...
const PhilippinesInvoicePrint = () => {
  ...
  useEffect(() => {
    if (id) {
      const storedInvoices = localStorage.getItem('philippinesInvoices');
      if (storedInvoices) {
  ...
  const handleBack = () => {
    if (location.state?.from) {
      ...
      navigate(`/philippines/invoice/edit/${id}`);
    }
  };
          ...
          <div className="border border-black">
            ...
            <div className="flex border-t border-black">
              ...
              <div className="w-1/2 p-2">
                ...
                <div>MAKATI DISTRICT</div>
                <div>METRO MANILA</div>
                <div>MANILA, PHILIPPINES</div>
                <div>PSN NO : {invoiceData.consignee?.idNumber || "1234567890123"}</div>
                <div className="mt-1 font-semibold">Mobile: {invoiceData.consignee?.mobile || "+63 917 123 4567"}</div>
              </div>
            </div>

            {/* Destination */}
            <div className="border-t border-black p-2 flex">
              <div className="font-bold">Destination Warehouse: Manila</div>
...
export default PhilippinesInvoicePrint;