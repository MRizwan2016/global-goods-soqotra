      ...
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900">Philippines Invoice</h1>
              <p className="text-gray-600">Create or edit invoice for Philippines destination</p>
            </div>
          </div>
...
export default PhilippinesInvoiceForm;